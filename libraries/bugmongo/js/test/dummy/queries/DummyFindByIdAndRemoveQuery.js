...
//@Export('bugmongo.DummyFindByIdAndRemoveQuery')
...
require('bugpack').context("*", function(bugpack) {
    ...
    var DummyFindByIdAndRemoveQuery = Class.extend(DummyMongoQuery, {
        ...
        _name: "bugmongo.DummyFindByIdAndRemoveQuery",
    ...
    bugpack.export('bugmongo.DummyFindByIdAndRemoveQuery', DummyFindByIdAndRemoveQuery);
});
