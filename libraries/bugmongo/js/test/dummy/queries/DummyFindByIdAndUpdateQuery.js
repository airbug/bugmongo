...
//@Export('bugmongo.DummyFindByIdAndUpdateQuery')
...
require('bugpack').context("*", function(bugpack) {
    ...
    var DummyFindByIdAndUpdateQuery = Class.extend(DummyMongoQuery, {
        ...
        _name: "bugmongo.DummyFindByIdAndUpdateQuery",
    ...
    bugpack.export('bugmongo.DummyFindByIdAndUpdateQuery', DummyFindByIdAndUpdateQuery);
});
