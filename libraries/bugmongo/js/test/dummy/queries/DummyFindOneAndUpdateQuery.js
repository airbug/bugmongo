...
//@Export('bugmongo.DummyFindOneAndUpdateQuery')
...
require('bugpack').context("*", function(bugpack) {
    ...
    var DummyFindOneAndUpdateQuery = Class.extend(DummyMongoQuery, {
        ...
        _name: "bugmongo.DummyFindOneAndUpdateQuery",
    ...
    bugpack.export('bugmongo.DummyFindOneAndUpdateQuery', DummyFindOneAndUpdateQuery);
});
